        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Injured in a Rideshare Accident? Get Paid FAST.
            </h1>
            <p className="text-xl md:text-2xl text-primary-100">
              We help you file, fight, and win your claim—hassle-free.
            </p>
          ...
          <motion.div
            ...
            id="contact-form"
            className="bg-white text-gray-900 rounded-lg shadow-xl p-6 md:p-8"
          >
            ...
            {isSubmitted ? (
              <div className="text-center py-8">
                ...
                <p className="mb-4">Your information has been submitted. Redirecting you to the next step...</p>
