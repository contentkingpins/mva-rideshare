        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              We help rideshare accident victims get the compensation they deserve quickly and hassle-free.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <span>
                  <a href="tel:8885555555" className="hover:text-white">
                    (888) 555-5555
                  </a>
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>
                  <a href="mailto:info@claimconnectors.com" className="hover:text-white">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Claim Connectors. All rights reserved.
            </div>
