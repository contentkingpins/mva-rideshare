...
export default function Step2Involvement({ register, errors, watch }: Step2Props) {
        ...
        <div className="space-y-3">
          <div className="flex items-start p-4 border rounded-lg hover:bg-gray-50 transition">
            <input
              ...
              {...register('role')}
            />
            <label htmlFor="role-passenger" className="ml-3 cursor-pointer">
          ...
          <div className="flex items-start p-4 border rounded-lg hover:bg-gray-50 transition">
            <input
              ...
              {...register('role')}
            />
            <label htmlFor="role-guest" className="ml-3 cursor-pointer">
          ...
          <div className="flex items-start p-4 border rounded-lg hover:bg-gray-50 transition">
            <input
              ...
              {...register('role')}
            />
            <label htmlFor="role-other-vehicle" className="ml-3 cursor-pointer">
