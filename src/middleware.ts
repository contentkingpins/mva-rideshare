...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://api.trustedform.com https://connect.facebook.net; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://randomuser.me https://api.trustedform.com https://www.facebook.com; font-src 'self'; connect-src 'self' https://randomuser.me https://bnmcip8xp5.execute-api.us-east-1.amazonaws.com https://api.activeprosper.com https://*.execute-api.us-east-1.amazonaws.com;"
  );
